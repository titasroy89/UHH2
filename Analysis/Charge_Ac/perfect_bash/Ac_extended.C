...
void Ac_extended(string pdf_name, Int_t max = 0) 
...
//    TTree *treereco1 = (TTree*) chreco1;
    ...
    //Rapidity
    Float_t bins_gen[] = {-2.5,-2.,-1.5,-1.,-0.5,0.,0.5,1.,1.5,2.,2.5};
    Float_t bins_rec[] = {-2.5,-2.,-1.5,-1.,-0.5,0.,0.5,1.,1.5,2.,2.5};
    Float_t new_rec[] = {-2.5,-2.,-1.75,-1.5,-1.25,-1.,-0.75,-0.5,-0.25,0.,0.25,0.5,0.75,1.,1.25,1.5,1.75,2.,2.5};
...
//    treereco1->Project("DeltaY_FullPS",Form("%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s)",rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str()));
    treereco->Project("DeltaY_gen_rec",Form("%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s)",rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str()));
    treereco->Project("DeltaY_rec",Form("%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s)","DeltaY","DeltaY","DeltaY","DeltaY","DeltaY"));
    treereco2->Project("DeltaY_Visgen",Form("%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s)",rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str()));
    treereco->Project("Smearing_Matrix",Form("%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s):%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s)",rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),"DeltaY","DeltaY","DeltaY","DeltaY","DeltaY"));

//Llenando histogramas para closure test


//rapidity
      treereco->Project("Smearing_Matrix_closure",Form("%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s):%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s)",rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),"DeltaY","DeltaY","DeltaY","DeltaY","DeltaY"),"","",8444,8491);
      treereco->Project("DeltaY_gen_closure",Form("%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s)",rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str(),rap_diff.c_str()),"","",7990,500);
      treereco->Project("DeltaY_rec_closure",Form("%s < -2.5? TMath::Max(-2.25,%s): (%s > 2.5? TMath::Min(2.25,%s) : %s)","DeltaY","DeltaY","DeltaY","DeltaY","DeltaY"),"","",7990,500);
...
//    Acceptance->Draw("same");
    ...
    Double_t Res_gauss[] = {0.6427,0.5,.448,.40,.37,.38,.42,.44,.44,.43};
...
//    leg.AddEntry(Acceptance,"Acceptance");
    ...
    auto ProY9 = (TH1*)Smearing_Matrix->ProjectionY("ProY9",9,9);
    auto ProY10 = (TH1*)Smearing_Matrix->ProjectionY("ProY10",10,10);
    ...
    TH1* hh9 = (TH1*) gDirectory->Get("ProY9");
    TH1* hh10 = (TH1*) gDirectory->Get("ProY10");
    ...
    gDirectory->WriteObject(hh9,"ProY9");
    gDirectory->WriteObject(hh10,"ProY10");
