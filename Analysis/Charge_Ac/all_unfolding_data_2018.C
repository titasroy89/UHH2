...
void all_unfolding_data_2018(string var_name = "")
{
...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_data->Add("/nfs/dust/cms/user/hugobg/Zprime_102X/analysis_output/2018/muon/workdir_Zprime_Analysis_muon_2018/*DATA.root/AnalysisTree");
    TTree *treereco_data = (TTree*) chreco_data;

    TChain *chreco_ttbar = new TChain("AnalysisTree","");
    chreco_ttbar->Add("/nfs/dust/cms/user/hugobg/Zprime_102X/analysis_output/2018/muon/workdir_Zprime_Analysis_muon_2018/*TTbar.root/AnalysisTree");
    TTree *treereco_ttbar = (TTree*) chreco_ttbar;

    TChain *chreco_wjets = new TChain("AnalysisTree","");
    chreco_wjets->Add("/nfs/dust/cms/user/hugobg/Zprime_102X/analysis_output/2018/muon/workdir_Zprime_Analysis_muon_2018/*WJets.root/AnalysisTree");
    TTree *treereco_wjets = (TTree*) chreco_wjets;

    TChain *chreco_ST = new TChain("AnalysisTree","");
    chreco_ST->Add("/nfs/dust/cms/user/hugobg/Zprime_102X/analysis_output/2018/muon/workdir_Zprime_Analysis_muon_2018/*ST.root/AnalysisTree");
    TTree *treereco_ST = (TTree*) chreco_ST;

    TChain *chreco_DY = new TChain("AnalysisTree","");
    chreco_DY->Add("/nfs/dust/cms/user/hugobg/Zprime_102X/analysis_output/2018/muon/workdir_Zprime_Analysis_muon_2018/*DYJets.root/AnalysisTree");
    TTree *treereco_DY = (TTree*) chreco_DY;

    TChain *chreco_QCD = new TChain("AnalysisTree","");
    chreco_QCD->Add("/nfs/dust/cms/user/hugobg/Zprime_102X/analysis_output/2018/muon/workdir_Zprime_Analysis_muon_2018/*QCD.root/AnalysisTree");
...
//------Migration_Matrices_for_syst_propagation-----?? 
    ...
    treereco_ttbar->Project("Migration_Matrix_cferr1",Form("%s < bin_gen[0] ? TMath::Max(bin_gen[0],%s): (%s > bin_gen[binnum_gen] ? TMath::Min(bin_gen[binnum_gen],%s) : %s):%s < bin_gen[0] ? TMath::Max(bin_gen[0],%s): (%s > bin_gen[binnum_gen] ? TMath::Min(bin_gen[binnum_gen],%s) : %s)",var_gen.c_str(),var_gen.c_str(),var_gen.c_str(),var_gen.c_str(),var_gen.c_str(),var_name.c_str(),var_name.c_str(),var_name.c_str(),var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu_up*weight_btagdisc_cferr1up*0.75",selcuts.c_str()));
...
//--------Filling_stack_plot-----??  
    THStack *hs = new THStack("hs",Form(";%s;",var_name.c_str()));
    ...
    Data->Draw("epsame"); 
    legend->Draw("same"); 
    cc->Print(Form("%s.pdf",var_name.c_str()));
