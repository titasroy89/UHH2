...
void unfolding(string pdf_name, Int_t N = 10000,Int_t bin = 2)
{
...
// Closure Test LCurve_min
      ...
      ratio_L->SetMaximum(1.5);
      ratio_L->SetMinimum(0.5);
...
//         cout << endl;
      ...
      DeltaY_gen->Scale(1000/Integral_gen);
