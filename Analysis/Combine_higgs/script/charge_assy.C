...
void charge_assy(){
   ...
   double x[] = {0, 1, 2, 3, 4};
   double y[] = {0.0119, 0.0119, 0.0119, 0.0119, 0.0119};
   double ey[] = {0.002, 0.002, 0.002, 0.002, 0.002};
   ...
   ge->GetXaxis()->SetTitle("Boosted t#bar{t} -> #mu + jets (M_{t #bar{t}} > 900 GeV)");
...
//   mg->Add(ge,"a3");
   ...
   latex.DrawLatex(0.02,0.102,"Work in progress");
