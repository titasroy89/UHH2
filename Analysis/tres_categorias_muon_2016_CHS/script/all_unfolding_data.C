...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_jec->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/muon/workdir_Zprime_Analysis_%s_CHS_jec/jec/uhh2.AnalysisModuleRunner.MC.TTToS*.root/AnalysisTree",year.c_str(),year.c_str()));
    TTree *treereco_ttbar_jec = (TTree*) chreco_ttbar_jec;

    //jer
    TChain *chreco_ttbar_jer = new TChain("AnalysisTree","");
    chreco_ttbar_jer->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/muon/workdir_Zprime_Analysis_%s_CHS_jer/jer/uhh2.AnalysisModuleRunner.MC.TTToS*.root/AnalysisTree",year.c_str(),year.c_str()));
