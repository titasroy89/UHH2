...
histName="DeltaY"
histograms = {
              "TTbar"   : ["#cbar #Delta y #cbar", "Events", 28, [-2.,-1.,-0.5,0.,0.5,1.,2.,3.,4.,4.5,5,6]],
              "WJets"   : ["#cbar #Delta y #cbar", "Events", 28, [-2.,-1.,-0.5,0.,0.5,1.,2.,3.,4.,4.5,5,6]],
              "ST"   : ["#cbar #Delta y #cbar", "Events", 28, [-2.,-1.,-0.5,0.,0.5,1.,2.,3.,4.,4.5,5,6]],
              "QCD"   : ["#cbar #Delta y #cbar", "Events", 28, [-2.,-1.,-0.5,0.,0.5,1.,2.,3.,4.,4.5,5,6]],
              "DY"   : ["#cbar #Delta y #cbar", "Events", 28, [-2.,-1.,-0.5,0.,0.5,1.,2.,3.,4.,4.5,5,6]],
}

sample_names = [ "TTbar", "DY", "QCD", "ST", "WJets"]
hist1_={}
for sample in sample_names:
    _file[sample] = TFile("dd_inputs.root","read")
...
_file["Data"] = TFile("dd_inputs.root","read")
...
if log:
    ...
    canvasRatio.SaveAs("dd_stack.pdf")
