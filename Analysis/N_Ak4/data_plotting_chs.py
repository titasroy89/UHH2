...
_fileDir ="/nfs/dust/cms/user/hugobg/ZPrime_10X/analysis_output/018/muon/"
...
stackList = { "TTbar_chs":[kRed], "TTbarh_chs":[kOrange], "TTbar2l_chs":[kMagenta],   "WJets_chs":[kGreen], "ST_chs":[kYellow], "DY_chs":[kBlue], "VV_chs":[kOrange], "QCD_chs":[kTeal]}
...
histName="N_Ak4"
histograms = {
              "TTbar_chs"   : ["N_Ak4", "Events", 8, [-2,-1.,-0.5,0.,0.5,1.,2.]],
              "TTbarh_chs"   : ["N_Ak4", "Events", 8, [-2,-1.,-0.5,0.,0.5,1.,2.]],
              "TTbar2l_chs"   : ["N_Ak4", "Events", 8, [-2,-1.,-0.5,0.,0.5,1.,2.]],
              "WJets_chs"   : ["N_Ak4", "Events", 8, [-2,-1.,-0.5,0.,0.5,1.,2]],
              "ST_chs"   : ["N_Ak4", "Events", 8, [-2.,-1.,-0.5,0.,0.5,1.,2.]],
              "QCD_chs"   : ["N_Ak4", "Events", 8, [-2.,-1.,-0.5,0.,0.5,1.,2.]],
              "DY_chs"   : ["N_Ak4", "Events", 8, [-2.,-1.,-0.5,0.,0.5,1.,2.]],
}

sample_names = [ "TTbar_chs", "TTbarh_chs", "TTbar2l_chs", "DY_chs", "QCD_chs", "ST_chs", "WJets_chs"]
hist1_={}
...
#labels = ["[-.,-1.5]","[-1.5,-1.5]","[-1.5,-1]","[-1,-0.75]","[-0.75,-0.5]","[-0.5,-0.5]","[-0.5,0]","[0,0.5]","[0.5,0.5]","[0.5,0.75]","[0.75,1.]","[1,1.5]","[1.5,1.5]","[1.5,.]",
#         "[-.,-1.5]","[-1.5,-1.5]","[-1.5,-1]","[-1,-0.75]","[-0.75,-0.5]","[-0.5,-0.5]","[-0.5,0]","[0,0.5]","[0.5,0.5]","[0.5,0.75]","[0.75,1.]","[1,1.5]","[1.5,1.5]","[1.5,.]"]
#"[-1.5,-1.5]","[-1.5,-1]","[-1,-0.75]","[-0.75,-0.5]","[-0.5,-0.5]","[-0.5,0]","[0,0.5]","[0.5,0.5]","[0.5,0.75]","[0.75,1.]","[1,1.5]","[1.5,1.5]","[1.5,.]"]
y=-400
...
ratio.GetXaxis().SetTitle(histograms["TTbar_chs"][0])
...
if log:
    ...
    canvasRatio.SaveAs("N_Ak4_stack_chs.pdf")
