...
stackList = { "TTbar_puppi":[kRed], "WJets_puppi":[kGreen], "ST_puppi":[kYellow], "DY_puppi":[kBlue], "VV_puppi":[kOrange], "QCD_puppi":[kTeal]}
...
histName="N_Ak4"
histograms = {
              "TTbar_puppi"   : ["N_Ak4", "Events", 8, [-2,-1.,-0.5,0.,0.5,1.,2.]],
              "WJets_puppi"   : ["N_Ak4", "Events", 8, [-2,-1.,-0.5,0.,0.5,1.,2]],
              "ST_puppi"   : ["N_Ak4", "Events", 8, [-2.,-1.,-0.5,0.,0.5,1.,2.]],
              "QCD_puppi"   : ["N_Ak4", "Events", 8, [-2.,-1.,-0.5,0.,0.5,1.,2.]],
              "DY_puppi"   : ["N_Ak4", "Events", 8, [-2.,-1.,-0.5,0.,0.5,1.,2.]],
}

sample_names = [ "TTbar_puppi", "DY_puppi", "QCD_puppi", "ST_puppi", "WJets_puppi"]
hist1_={}
...
ratio.GetXaxis().SetTitle(histograms["TTbar_puppi"][0])
...
if log:
    ...
    canvasRatio.SaveAs("N_Ak4_stack.pdf")
