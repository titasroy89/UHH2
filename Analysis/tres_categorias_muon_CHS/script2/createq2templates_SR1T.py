...
systematic_direction_ttbar={'nominal':ct_top,
                            'q2ttbarMuRdnMuFdn__plus':'(weight)*(weight_murmuf_downdown)',
                            'q2ttbarMuRupMuFup__plus':'(weight)*(weight_murmuf_upup)',
                            'q2ttbarMuRdnMuFct__plus':'(weight)*(weight_murmuf_downnone)',
                            'q2ttbarMuRupMuFct__plus':'(weight)*(weight_murmuf_upnone)',
                            'q2ttbarMuRctMuFdn__plus':'(weight)*(weight_murmuf_nonedown)',
                            'q2ttbarMuRctMuFup__plus':'(weight)*(weight_murmuf_noneup)'
                           }
