...
stackList = { "TTToSemiLeptonic_2018":[kRed], "DYJetsToLL_M-50_HT_2018":[kGreen], "QCD_HT_2018":[kYellow], "WJetsToLNu_2018":[kBlue], "ST_2018":[kOrange], "WW_WZ_ZZ_2018":[kTeal]}
...
#             "met_pt"   : ["missing E_{T} [GeV]", "Events", 10, [50,1500]],
              ...
              "Ak8_j1_mSD": ["Ak8_j1_mSD", "Events", 25, [40,220]],
              "W_tagged_jet":["W_tagged_jet","Events",25,[40,200]], 
}

#sample_names = ["QCD","ST","DYJets","WJets","TTbar"]
#sample_names = ["TTToSemiLeptonic_2018_2"]
sample_names = [ "DYJetsToLL_M-50_HT_2018", "QCD_HT_2018", "WJetsToLNu_2018", "ST_2018", "WW_WZ_ZZ_2018", "TTToSemiLeptonic_2018"]
...
#                else:
	        tree2_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"weight*(rec_chi2 > 30 &&  btagN == 0)")
...
tree.Draw("%s>>dat_hist(%i,%i,%f)"%(histName,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]), "rec_chi2 > 30 && btagN == 0")
