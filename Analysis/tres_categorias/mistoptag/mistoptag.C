...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2018/muon/uhh2.AnalysisModuleRunner.MC.TTT*.root/AnalysisTree");
    TTree *treereco_ttbar = (TTree*) chreco_ttbar;

    TChain *chreco_wjets = new TChain("AnalysisTree","");
    chreco_wjets->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2018/muon/uhh2.AnalysisModuleRunner.MC.WJ*.root/AnalysisTree");
    TTree *treereco_wjets = (TTree*) chreco_wjets;

    TChain *chreco_ST = new TChain("AnalysisTree","");
    chreco_ST->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2018/muon/uhh2.AnalysisModuleRunner.MC.ST*.root/AnalysisTree");
    TTree *treereco_ST = (TTree*) chreco_ST;

    TChain *chreco_DY = new TChain("AnalysisTree","");
    chreco_DY->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2018/muon/uhh2.AnalysisModuleRunner.MC.DYJets*.root/AnalysisTree");
    TTree *treereco_DY = (TTree*) chreco_DY;

    TChain *chreco_QCD = new TChain("AnalysisTree","");
    chreco_QCD->Add("/nfs/dust/cms/user/hugobg/ZpPrime_102X/analysis_output/2018/muon/uhh2.AnalysisModuleRunner.MC.QCD*.root/AnalysisTree");
    TTree *treereco_QCD = (TTree*) chreco_QCD;
 
    TChain *chreco_data = new TChain("AnalysisTree","");
    chreco_data->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2018/muon/uhh2.AnalysisModuleRunner.DATA.DATA_SingleMuon_Run2018.root/AnalysisTree");
