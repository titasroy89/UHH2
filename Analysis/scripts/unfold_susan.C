...
//           <<" / "<<unfold.GetNdf()<<"\n";
  ...
  TH1 *totUnc =  (TH1*) tem->Clone("totUnc");
      ...
      totUnc->GetYaxis()->SetRangeUser(0.0,3.0);
...
// Closure Test LCurve_min
      ...
      TH1 *ratio_L =  (TH1*) Mttbar_gen->Clone("ratio");
      ratio_L->SetName("ratio");
      ratio_L->GetXaxis()->SetTitle("Mttbar [GeV]");
      ...
      histMunfold_L->SetAxisRange(0,max(Mttbar_gen->GetMaximum(),histMunfold->GetMaximum())*1.15,"Y");
      histMunfold_L->Draw();
      Mttbar_gen->Draw("histsame");
      Mttbar->Draw("same");
      ...
      leg4L->AddEntry(Mttbar_gen, "Generator prediction","l");
      leg4L->AddEntry(Mttbar, "Reconstructed events","p");
      ...
      ratio_L->SetMaximum(1.35);
      ratio_L->SetMinimum(0.65);
    ...
    Float_t rec2A[] = {900,985,1070,1260,1455,1575,1700,1850,2000,2175,2350,2650,3000,4250,5500};

    Int_t  rec2 = sizeof(rec2A)/sizeof(Float_t) - 1;
      ...
      Int_t count = 0;
      Int_t Integral = Mttbar->Integral();

      for(int bb=0;bb<1000;bb++){
        TH1F *Bias = new TH1F("Bias","",rec2,rec2A);
        gRandom->SetSeed(bb);
        Bias->FillRandom(Mttbar,Integral);
     ...
     Float_t bias[8];
     bias[0] = (mean(Bin_1) - Mttbar_gen->GetBinContent(1))/Mttbar_gen->GetBinContent(1);
     bias[1] = (mean(Bin_2) - Mttbar_gen->GetBinContent(2))/Mttbar_gen->GetBinContent(2);
     bias[2] = (mean(Bin_3) - Mttbar_gen->GetBinContent(3))/Mttbar_gen->GetBinContent(3);
     bias[3] = (mean(Bin_4) - Mttbar_gen->GetBinContent(4))/Mttbar_gen->GetBinContent(4);
     bias[4] = (mean(Bin_5) - Mttbar_gen->GetBinContent(5))/Mttbar_gen->GetBinContent(5);
     bias[5] = (mean(Bin_6) - Mttbar_gen->GetBinContent(6))/Mttbar_gen->GetBinContent(6);
     bias[6] = (mean(Bin_7) - Mttbar_gen->GetBinContent(7))/Mttbar_gen->GetBinContent(7);
     bias[7] = (mean(Bin_8) - Mttbar_gen->GetBinContent(8))/Mttbar_gen->GetBinContent(8);

     Float_t bias_R[8];
     bias_R[0] = (mean(Bin_1R) - Mttbar_gen->GetBinContent(1))/Mttbar_gen->GetBinContent(1);
     bias_R[1] = (mean(Bin_2R) - Mttbar_gen->GetBinContent(2))/Mttbar_gen->GetBinContent(2);
     bias_R[2] = (mean(Bin_3R) - Mttbar_gen->GetBinContent(3))/Mttbar_gen->GetBinContent(3);
     bias_R[3] = (mean(Bin_4R) - Mttbar_gen->GetBinContent(4))/Mttbar_gen->GetBinContent(4);
     bias_R[4] = (mean(Bin_5R) - Mttbar_gen->GetBinContent(5))/Mttbar_gen->GetBinContent(5);
     bias_R[5] = (mean(Bin_6R) - Mttbar_gen->GetBinContent(6))/Mttbar_gen->GetBinContent(6);
     bias_R[6] = (mean(Bin_7R) - Mttbar_gen->GetBinContent(7))/Mttbar_gen->GetBinContent(7);
     bias_R[7] = (mean(Bin_8R) - Mttbar_gen->GetBinContent(8))/Mttbar_gen->GetBinContent(8);

     Float_t xx[8] = {1,2,3,4,5,6,7,8};

     Float_t error[8], error_R[8];

     error[0] = (sigma(Bin_1)+Mttbar_gen->GetBinError(1))/abs(Mttbar_gen->GetBinContent(1)-mean(Bin_1));
     error[1] = (sigma(Bin_2)+Mttbar_gen->GetBinError(2))/abs(Mttbar_gen->GetBinContent(2)-mean(Bin_2));
     error[2] = (sigma(Bin_3)+Mttbar_gen->GetBinError(3))/abs(Mttbar_gen->GetBinContent(3)-mean(Bin_3));
     error[3] = (sigma(Bin_4)+Mttbar_gen->GetBinError(4))/abs(Mttbar_gen->GetBinContent(4)-mean(Bin_4));
     error[4] = (sigma(Bin_5)+Mttbar_gen->GetBinError(5))/abs(Mttbar_gen->GetBinContent(5)-mean(Bin_5));
     error[5] = (sigma(Bin_6)+Mttbar_gen->GetBinError(6))/abs(Mttbar_gen->GetBinContent(6)-mean(Bin_6));
     error[6] = (sigma(Bin_7)+Mttbar_gen->GetBinError(7))/abs(Mttbar_gen->GetBinContent(7)-mean(Bin_7));
     error[7] = (sigma(Bin_8)+Mttbar_gen->GetBinError(8))/abs(Mttbar_gen->GetBinContent(8)-mean(Bin_8));

     error_R[0] = (sigma(Bin_1R)+Mttbar_gen->GetBinError(1))/abs(Mttbar_gen->GetBinContent(1)-mean(Bin_1R));
     error_R[1] = (sigma(Bin_2R)+Mttbar_gen->GetBinError(2))/abs(Mttbar_gen->GetBinContent(2)-mean(Bin_2R));
     error_R[2] = (sigma(Bin_3R)+Mttbar_gen->GetBinError(3))/abs(Mttbar_gen->GetBinContent(3)-mean(Bin_3R));
     error_R[3] = (sigma(Bin_4R)+Mttbar_gen->GetBinError(4))/abs(Mttbar_gen->GetBinContent(4)-mean(Bin_4R));
     error_R[4] = (sigma(Bin_5R)+Mttbar_gen->GetBinError(5))/abs(Mttbar_gen->GetBinContent(5)-mean(Bin_5R));
     error_R[5] = (sigma(Bin_6R)+Mttbar_gen->GetBinError(6))/abs(Mttbar_gen->GetBinContent(6)-mean(Bin_6R));
     error_R[6] = (sigma(Bin_7R)+Mttbar_gen->GetBinError(7))/abs(Mttbar_gen->GetBinContent(7)-mean(Bin_7R));
     error_R[7] = (sigma(Bin_8R)+Mttbar_gen->GetBinError(8))/abs(Mttbar_gen->GetBinContent(8)-mean(Bin_8R));

     Float_t error_gen[8];

     error_gen[0] = Mttbar_gen->GetBinError(1)/Mttbar_gen->GetBinContent(1);
     error_gen[1] = Mttbar_gen->GetBinError(2)/Mttbar_gen->GetBinContent(2);
     error_gen[2] = Mttbar_gen->GetBinError(3)/Mttbar_gen->GetBinContent(3);
     error_gen[3] = Mttbar_gen->GetBinError(4)/Mttbar_gen->GetBinContent(4);
     error_gen[4] = Mttbar_gen->GetBinError(5)/Mttbar_gen->GetBinContent(5);
     error_gen[5] = Mttbar_gen->GetBinError(6)/Mttbar_gen->GetBinContent(6);
     error_gen[6] = Mttbar_gen->GetBinError(7)/Mttbar_gen->GetBinContent(7);
     error_gen[7] = Mttbar_gen->GetBinError(8)/Mttbar_gen->GetBinContent(8);
...
//     gr->GetXaxis()->SetTitle("Mttbar");
//     gr->GetYaxis()->SetTitle("Bias");
//     gr->Draw();
//     C3->cd(2);
     gr_R->GetXaxis()->SetTitle("Mttbar");
