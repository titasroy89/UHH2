...
_fileDir ="/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2016/muon/"
#_fileDir ="/nfs/dust/cms/user/hugobg/Zprime_102X/analysis_output/2016/muon/workdir_Zprime_Analysis_2016_muon_ttag_btag_muonID/"
...
stackList = { "TTToSemiLeptonic_2016":[kRed], "DYJetsToLL_M-50_HT_2016":[kBlue], "QCD_HT_2016":[kTeal], "WJetsToLNu_2016":[kGreen], "ST_2016":[kYellow], "WW_WZ_ZZ_2016":[kOrange]}
...
#              "TL_M": ["TL_M", "Events", 40, [20,300]],
              "pT_had": ["pT_had", "Events", 25, [0,1200]],
...
sample_names = [ "DYJetsToLL_M-50_HT_2016", "QCD_HT_2016", "WJetsToLNu_2016", "ST_2016", "WW_WZ_ZZ_2016", "TTToSemiLeptonic_2016"]
...
#                if(sample == "TTToSemiLeptonic_2018_2"):
#			tree2_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"(wtagN == 1 && btagN>=2)*1")   
#                else:
	        tree2_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"weight*weight_pu*weight_sfmu_MuonID*weight_sfmu_MuonTrigger*(btagN>=1)")
#                tree2_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"weight*0.93*(btagN==0 && rec_chi2 > 30)")
...
tree.Draw("%s>>dat_hist(%i,%i,%f)"%(histName,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"(btagN>=1)")
