...
stackList = { "TTToSemiLeptonic_2016":[kRed], "DYJetsToLL_M-50_HT_2016":[kGreen], "QCD_HT_2016":[kYellow], "WJetsToLNu_2016":[kBlue], "ST_2016":[kOrange], "WW_WZ_ZZ_2016":[kTeal]}
...
#             "met_pt"   : ["missing E_{T} [GeV]", "Events", 10, [50,1500]],
              "rec_chi2": ["rec_chi2", "Events", 20, [0,30]],  
...
for sample in sample_names:
		...
		tree2_MC[sample]=_file[sample].Get("AnalysisTree")
	        tree2_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"weight*weight_pu*(rec_chi2 < 30 && btagN >= 1)")
...
tree.Draw("%s>>dat_hist(%i,%i,%f)"%(histName,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]), "rec_chi2 < 30 && btagN >= 1")
