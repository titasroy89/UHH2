...
//      EL->Print(Form("Error_Matrix_(Lscan)_%s.pdf",pdf_name.c_str()));
      ...
      latex3.DrawLatex(1.1,histMunfold_L->GetMaximum()*1.01,"36.77 fb^{-1} (13 TeV)");
      ...
      c5->Update();
      c5->Draw();
      c5->Print(Form("Closure_electron_2016.pdf",pdf_name.c_str()));
...
//     gr_bias->Draw("same p");
     ...
     latex6.DrawLatex(0.8,0.5*1.01,"36.77 fb^{-1} (13 TeV)");

     C4->Print(Form("Bias_electron_2016.pdf",pdf_name.c_str()));
