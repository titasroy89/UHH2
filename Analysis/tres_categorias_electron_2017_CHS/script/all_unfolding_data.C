...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_others->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/electron/uhh2.AnalysisModuleRunner.MC.TTToO*.root/AnalysisTree",year.c_str()));
    ...
    chreco_ttbar_semi_semi_jec->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/electron/workdir_Zprime_Analysis_%sv2_electron_CHS_jec/jec/uhh2.AnalysisModuleRunner.MC.TTToS*.root/AnalysisTree",year.c_str(),year.c_str()));
    ...
    chreco_ttbar_semi_semi_jer->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/electron/workdir_Zprime_Analysis_%sv2_electron_CHS_jer/jer/uhh2.AnalysisModuleRunner.MC.TTToS*.root/AnalysisTree",year.c_str(),year.c_str()));
...
//------Filling_bkgs---------??
    ...
    treereco_ttbar_semi->Project("TTbar_semiresolved",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_central.c_str()));
    ...
    treereco_ttbar_semi->Project("TTbar_resolved",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_central.c_str()));
...
//boosted
    treereco_ttbar_semi->Project("ttbar_semi_boosted_pu_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu_up*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_pu_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu_down*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_MuonID_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID_up*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_central.c_str())); 
    treereco_ttbar_semi->Project("ttbar_semi_boosted_MuonID_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID_down*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_Trigger_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_up*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_Trigger_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_down*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_mistag_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_mistag_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_cferr1_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr1up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_cferr1_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr1down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_cferr2_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr2up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_up.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_boosted_hfstats2_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_hfstats2down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_boosted_jes_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_jesdown*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_lfstats1_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats1up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_lfstats1_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats1down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_boosted_lfstats2_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats2down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_ptrew_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_ptrew_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew_down*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_ptrew_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_up_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_ptrew_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_down_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_boosted_muonrec_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_down_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)_up",selcuts_boosted_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_boosted_muonrec_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_down_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)_down",selcuts_boosted_down.c_str()));
...
//semiresolved
    ...
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_pu_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu_up*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_pu_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu_down*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_MuonID_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID_up*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_MuonID_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID_down*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_Trigger_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_up*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_Trigger_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_down*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_mistag_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_up*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_mistag_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_down*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_cferr1_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr1up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_cferr1_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr1down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_cferr2_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr2up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_up.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_hf_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_btagdisc_hfup*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_hf_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_hfdown*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_lf_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfup*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_lf_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfdown*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_hfstats1_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_hfstats1up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_hfstats1_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_hfstats1down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_hfstats2_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_hfstats2down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_jes_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_jesdown*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_lfstats1_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats1up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_lfstats1_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats1down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_lfstats2_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats2down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_ptrew_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_ptrew_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew_down*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_ptrew_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_up_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_ptrew_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_down_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_muonrec_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_down_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)_up",selcuts_semiresolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_semiresolved_muonrec_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_down_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)_down",selcuts_semiresolved_down.c_str()));
...
//resolved
    ...
    treereco_ttbar_semi->Project("ttbar_semi_resolved_pu_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu_up*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_pu_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu_down*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_MuonID_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID_up*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_MuonID_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID_down*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_Trigger_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_up*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_Trigger_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_down*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_central.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_mistag_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_up*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_mistag_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger_down*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_cferr1_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr1up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_cferr1_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr1down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_cferr2_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr2up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_cferr2_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_cferr2down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_hf_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_btagdisc_hfup*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_hf_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_hfdown*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_lf_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfup*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_lf_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfdown*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_hfstats1_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_hfstats1up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_hfstats1_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_hfstats1down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_resolved_hfstats2_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_hfstats2down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_resolved_jes_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_jesdown*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_lfstats1_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats1up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_lfstats1_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats1down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_lfstats2_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats2up*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_lfstats2_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_lfstats2down*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_ptrew_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_ptrew_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew_down*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_ptrew_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_up_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_up.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_ptrew_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_down_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_down.c_str()));
    ...
    treereco_ttbar_semi->Project("ttbar_semi_resolved_muonrec_up",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_down_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)_up",selcuts_resolved_down.c_str()));
    treereco_ttbar_semi->Project("ttbar_semi_resolved_muonrec_down",Form("%s < %f ? TMath::Max(%f,%s): (%s > %f ? TMath::Min(%f,%s) : %s)",var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str(),var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_down_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)_down",selcuts_resolved_down.c_str()));
...
//boosted
    treereco_ttbar_semi->Project("Migration_Matrix_boosted",Form("%s < %f ? %f : (%s > %f ? %f : %s) : %s < %f ? %f : (%s > %f ? %f : %s)",var_gen.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_gen.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_gen.c_str(),var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_central.c_str()));
    treereco_ttbar_semi->Project("Var_gen_boosted",Form("%s < %f ? %f : (%s > %f ? %f : %s)",var_gen.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_gen.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_gen.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_boosted_central.c_str()));

//semiresolved

    treereco_ttbar_semi->Project("Migration_Matrix_semiresolved",Form("%s < %f ? %f : (%s > %f ? %f : %s) : %s < %f ? %f : (%s > %f ? %f : %s)",var_gen.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_gen.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_gen.c_str(),var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_central.c_str()));
    treereco_ttbar_semi->Project("Var_gen_semiresolved",Form("%s < %f ? %f : (%s > %f ? %f : %s)",var_gen.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_gen.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_gen.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_semiresolved_central.c_str()));

//resolved

    treereco_ttbar_semi->Project("Migration_Matrix_resolved",Form("%s < %f ? %f : (%s > %f ? %f : %s) : %s < %f ? %f : (%s > %f ? %f : %s)",var_gen.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_gen.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_gen.c_str(),var_name.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_name.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_name.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_central.c_str()));
    treereco_ttbar_semi->Project("Var_gen_resolved",Form("%s < %f ? %f : (%s > %f ? %f : %s)",var_gen.c_str(),bins_gen[0]+0.01,bins_gen[0]+0.01,var_gen.c_str(),bins_gen[binnum_gen]-0.01,bins_gen[binnum_gen]-0.01,var_gen.c_str()),Form("%s*weight*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*(weight_sfelec_Rec)*(weight_sfelec_HT)",selcuts_resolved_central.c_str()));
...
*/
   ...
   latex2.DrawLatex(0.9,2.05,"36.73 fb^{-1} (13 TeV)");
...
// Purity && Stability
   ...
   latex4.DrawLatex(1.1,1.04,"36.73 fb^{-1} (13 TeV)");
