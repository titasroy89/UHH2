...
'vv':'uhh2.AnalysisModuleRunner.MC.WW_WZ_ZZ_2017v2.root',
...
categories=['T1']
fout = TFile('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/tres_categorias_electron_2017_CHS/'+argv[1]+'_muon_3cat_'+name+'.root', 'recreate')
...
for cat in categories:
    if cat == 'T1':
            ...
            for key_sample in samplelist:
                ...
                gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/tres_categorias_electron_2017_CHS/'+argv[1]+'_muon_3cat_'+name+'.root:/')
                if key_sample == 'DATA':
                    gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/tres_categorias_electron_2017_CHS/'+argv[1]+'_muon_3cat_'+name+'.root:/')
                    cut = argv[2]
                    print("--------------------------------------")
