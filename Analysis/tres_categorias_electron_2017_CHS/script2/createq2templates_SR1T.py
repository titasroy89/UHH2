...
ct_top = '(weight)*weight_sfelec_TightID*weight_sfelec_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*weight_sfelec_Rec'
...
samplelist = {
'ttbar':'/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2017_CHS/electron/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2017v2.root'
}
